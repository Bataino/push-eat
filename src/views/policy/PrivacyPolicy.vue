<template>
  <div class="px-5">
    ...
    Like most website operators, Push Eat collects non-personally-identifying information of the sort that web browsers
    and servers typically make available, such as the browser type, language preference, referring site, and the date and
    time of each visitor request. Push Eat's purpose in collecting non-personally identifying information is to better
    ...
    cookies by Push Eat and does not cover the use of cookies by any advertisers.<br>
    ...
    Push Eat discloses potentially personally-identifying and personally-identifying information only to those of its
    employees, contractors and affiliated organizations that:<br>

    (i) need to know that information in order to process it on Push Eat's behalf or to provide services available at Push
    ...
    may be located outside of your home country; by using Push Eat's website, you consent to the transfer of such
    information to them. Push Eat will not rent or sell potentially personally-identifying and personally-identifying
  ...
  help us support other users. Push Eat takes all measures reasonably necessary to protect against the unauthorized
  ...
  Push Eat may collect statistics about the behavior of visitors to its website. Push Eat may display this information
  publicly or provide it to others. However, Push Eat does not disclose your personally-identifying information.<br>
...
>
  To enrich and perfect your online experience, Push Eat uses "Cookies", similar technologies and services provided by
  ...
  Those who engage in transactions with Push Eat – by purchasing Push Eat's services or products, are asked to provide
  additional information, including as necessary the personal and financial information required to process those
  transactions. In each case, Push Eat collects such information only insofar as is necessary or appropriate to fulfill
  the purpose of the visitor's interaction with Push Eat. Push Eat does not disclose personally-identifying information
  ...
  If Push Eat, or substantially all of its assets, were acquired, or in the unlikely event that Push Eat goes out of
  business or enters bankruptcy, user information would be one of the assets that is transferred or acquired by a third
  party. You acknowledge that such transfers may occur, and that any acquirer of Push Eat may continue to use your
  personal information as set forth in this policy.<br>

  <br><b class="nexa-bold">Privacy Policy Changes</b> <br>

  Although most changes are likely to be minor, Push Eat may change its Privacy Policy from time to time, and in Push
  Eat's sole discretion. Push Eat encourages visitors to frequently check this page for any changes to its Privacy
